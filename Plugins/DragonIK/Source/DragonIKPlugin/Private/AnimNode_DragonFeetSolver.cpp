		...
		for (int feet_index = 0; feet_index < spine_hit_pairs[spine_index].RV_Feet_Hits.Num(); feet_index++)
		{
			...
			if (spine_hit_pairs[spine_index].RV_Feet_Hits[feet_index].bBlockingHit)
			{
				...
				if (spine_hit_pairs[spine_index].RV_Feet_Hits[feet_index].bBlockingHit && atleast_one_hit)
				{
					...
					FRotator rotated_rot = RotationFromImpactNormal(Output, normal_impact, Output.Pose.GetComponentSpaceTransform(spine_Feet_pair[spine_index].Associated_Feet[feet_index].CachedCompactPoseIndex), feet_limit);
				...
				{
					{
						...
						*/
						...
						FRotator rotated_finger_rot = RotationFromImpactNormal(Output, normal_finger_impact, ComponentBoneTransform_Finger, feet_limit);
...
FRotator FAnimNode_DragonFeetSolver::RotationFromImpactNormal(FComponentSpacePoseContext& Output, FVector normal_impact_input, FTransform original_Bone_transform, float feet_limit)
{
