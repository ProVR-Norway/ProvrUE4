...
//	FVector cs_forward = (((UpperLimbCSTransform.GetLocation() + EndBoneCSTransform.GetLocation() + LowerLimbCSTransform.GetLocation()) / 3) - (Knee_Transform_Default.GetLocation() + Elbow_Pole_Offset )).GetSafeNormal();

	FVector cs_forward = (((UpperLimbCSTransform.GetLocation() + EndBoneCSTransform.GetLocation() + LowerLimbCSTransform.GetLocation()) / 3) - (LowerLimbCSTransform.GetLocation() + Elbow_Pole_Offset)).GetSafeNormal();
