							...
							if (Connector_Index.GetInt() > 0)
							{
								...
								if (!ignore_elbow_modification)
								{
									...
									if (Arm_TargetLocation_Overrides.Arm_TargetLocation_Overrides.Num() > Main_Arm_Index)
									{
										...
										{
											FQuat Offseted_Rotation_Value = owning_skel->GetComponentToWorld().GetRotation().Inverse() * Arm_TargetLocation_Overrides.Arm_TargetLocation_Overrides[Main_Arm_Index].Overrided_Arm_Transform.GetRotation();
					...
					if ( (Actual_Shoulder_Array[limb_index].IsValidToEvaluate() && Elbow_Array[limb_index].IsValidToEvaluate() && Hand_Array[limb_index].IsValidToEvaluate()) && (limb_index != Main_Arm_Index || Main_Arm_Index < 0 || reach_instead) )
					{
						...
						if (Use_Separate_Targets)
						{
							...
							if (Arm_TargetLocation_Overrides.Arm_TargetLocation_Overrides.Num() > limb_index)
							{
								...
								Arm_LookTarget = Arm_TargetLocation_Overrides.Arm_TargetLocation_Overrides[limb_index].Overrided_Arm_Transform.GetLocation();
						...
						if (Connector_Index.GetInt() > 0)
						{
							...
							if (!ignore_elbow_modification)
							{
								...
								if (Arm_TargetLocation_Overrides.Arm_TargetLocation_Overrides.Num() > limb_index)
								{
									...
									if (Override_Hand_Rotation)
									{
										FQuat Offseted_Rotation_Value = owning_skel->GetComponentToWorld().GetRotation().Inverse() * Arm_TargetLocation_Overrides.Arm_TargetLocation_Overrides[limb_index].Overrided_Arm_Transform.GetRotation();
